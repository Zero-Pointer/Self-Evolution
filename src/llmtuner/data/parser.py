...
class DatasetAttr:
    ...
    """ flag for use instruction or not """
    not_use_prompt: Optional[bool] = False
...
#         dataset_names = []
        dataset_info = {}
        for i, file in enumerate(data_args.dataset_file.split(',')):
            dataset_info[f'my_data_{i}'] = {
                    'file_name': file
                }
            dataset_names.append(f'my_data_{i}')
